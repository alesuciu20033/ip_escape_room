...
//           if userGuess.count == 4 {
//               if userGuess == correctPassword {
//                   feedbackColor = .green.opacity(0.8)
//               } else {
//                   feedbackColor = .red.opacity(0.8)
//                   triesLeft -= 1
//               }
//               userGuess = ""
//               pressedButtons = []
...
//                                } else {
//                                    Circle()
//                                        .fill(viewModel.pressedButtons.contains(number) ? Color.gray.opacity(0.5) : Color.white)
//                                        .frame(width: 70, height: 70)
//                                        .overlay(
//                                            Text("\(number)")
//                                                .font(.system(size: 30, weight: .bold))
